...
export default function App() {
  ...
  const experienceData = [
    ...
    },
    {
      ...
      description:
        "Built live, data-rich UI for a Sports platform, improving rendering speed by 40% and reducing API load by 35%. Developed interactive components for Media clients.",
  ...
  const domainsData = [
    {
      title: "Banking",
      description:
        "Experience in developing secure, scalable AEM solutions for financial clients with focus on deployment automation and authoring efficiency.",
    },
    {
      title: "Telecom",
      description:
        "Worked on telecom projects building modular AEM components, improving customer portals, and enabling smooth digital experiences.",
    },
    {
      title: "Aerospace",
      description:
        "Contributed to aerospace domain projects by implementing performance-optimized front-end features and reusable UI components for critical dashboards.",
    },
    {
      title: "Media",
      description:
        "Developed rich media solutions ensuring responsive and high-performing interfaces for news and entertainment clients.",
    },
    {
      title: "Sports",
      description:
        "Built highly interactive and real-time data-driven sports platforms improving live updates and engagement features.",
    },
  ];
  ...
  const articlesData = [
    {
      ...
      description:
        "An easy guide to improve app performance by rendering only visible items with react-virtualized.",
    ...
    },
    {
      ...
      description:
        "Detailed comparison of useEffect and useLayoutEffect hooks with real-world examples.",
  ...
  const projectsData = [
    {
      ...
      description:
        "A portfolio-style photography application built using React and modern CSS.",
    ...
    },
    {
      ...
      title: "Wordle Game",
      description:
        "A fun Wordle clone built with React, complete with animations and game state management.",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0a192f] via-[#0f2340] to-[#112240] text-[#e6f1ff] font-sans flex flex-col md:flex-row">
      ...
      <motion.nav
        ...
        className="hidden md:flex md:w-2/5 h-screen flex-col items-center justify-between p-10 fixed left-0 bg-transparent"
      >
        <div className="flex flex-col items-center md:items-start space-y-10">
          ...
          <motion.h2
            ...
            className="text-lg md:text-xl text-[#64ffda]"
          >
        ...
        <motion.div
          ...
          className="flex space-x-8 text-2xl mt-12 md:mt-0"
        >
          <a
      ...
      <div className="md:ml-[40%] md:w-3/5 w-full px-6 md:px-20 py-12 space-y-32">
        ...
        >
          ...
          <p className="text-lg text-gray-300 leading-relaxed max-w-3xl">
            I craft accessible, pixel-perfect digital experiences for the web.
            With 4.2 years of experience across{" "}
            <span className="text-[#64ffda]">
              Banking, Telecom, Aerospace, Media, and Sports domains
            </span>
            , I specialize in ReactJS, Adobe Experience Manager (AEM), and
        ...
        <motion.footer
          ...
          className="text-gray-500 text-sm text-center pt-20"
        >
          © 2025 Sai Teja. Portfolio built with React & Tailwind.
        </motion.footer>
      </div>
    </div>
  );
